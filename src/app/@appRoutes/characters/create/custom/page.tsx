            ...
            <div className="relative p-8 min-h-screen">
                ...
                <div className="absolute top-4 left-4 flex items-center group">
                    { currentPage > 0 && (
                        <button
                            onClick={ goBack }
                            className="flex items-center text-3xl mr-2 transition-all duration-300 group-hover:scale-125 origin-left"
                        >
                            <MoveLeftIcon/>
                ...
                <div className="absolute top-4 right-4 flex items-center group">
                    { currentPage < totalPages - 1 && (
                        <button
                            onClick={ goNext }
                            className="flex items-center text-3xl transition-all duration-300 group-hover:scale-125 origin-right"
                        >
